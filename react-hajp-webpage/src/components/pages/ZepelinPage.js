      ...
      <div className='main-container'>
        ...
        <div className='content-container'>
          <p className='text-2'>Iako osnovana prije svega 4 godine, plesna grupa nastupala je na brojnim eventima u Slavoniji
            kao što su Ferivi maraton, Hang-Loose 60s party, plesni kamp u Orahovici te mnogim drugi.</p>
          <img src={require('../images/zepelin-2.jpeg')} className='image image-right'></img>
        </div>
        <div className='content-container'>
          <img src={require('../images/zepelin-medalje.jpeg')} className='image'></img>
          <p className='text-1'> Na Cro Dance Challenge-u 2023. uz vodstvo trenera, mentora i osnivača Josipa Bišćana, 
          osvojili smo zlatnu medalju za "Najbolju urbanu koreografiju" te pehara za najveću nagradu natjecanja "Najbolji scenski nastup".</p>
        </div>
      </div>
    </div>
  )
