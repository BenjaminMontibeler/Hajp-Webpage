  ...
  return (
    <div className='party-container'>
      ...
      <div className='party-content d-flex justify-content-between'>
        ...
        <p className='description-1 my-auto justify-content-center' data-aos="fade-left">Svaki mjesec plesni studio Hajp, 
        u suradnji s Campus Caffeom, organiriza tematski party "Hajp".</p>
      </div>

      <div className='party-content d-flex justify-content-between'>
        <p className='description-2 my-auto justify-content-center text-end' data-aos="fade-right">Plesaći iz svih osječkih
      ...
      <div className='party-content-2 container-fluid'>
        <div className='row justify-content-space-evenly justify-content-center'>
          ...
          <p className='description-3 text-center' data-aos="fade-up">Od y2k-a, do Halloween-a, do Lip Sync-a, teme Hajpa nikad 
